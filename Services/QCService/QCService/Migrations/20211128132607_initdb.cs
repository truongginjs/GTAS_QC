    ...
    public partial class initdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_L01_CuttingTableLib", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "L01_DepartmentLib",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_L01_DepartmentLib", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_L01_SiteLib", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefectTypesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZoneTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreateUserId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_L01_HandlerDefectLib_L01_QCZoneTypeLib_ZoneTypeId",
                        column: x => x.ZoneTypeId,
                        principalTable: "L01_QCZoneTypeLib",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_L01_TimeDefectLib_L01_QCZoneTypeLib_ZoneTypeId",
                        column: x => x.ZoneTypeId,
                        principalTable: "L01_QCZoneTypeLib",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_L01_HandlerDefectLib_ZoneTypeId",
                table: "L01_HandlerDefectLib",
                column: "ZoneTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_L01_QCZoneTypeLib_Code_Name_No_Prefix",
                table: "L01_QCZoneTypeLib",
                columns: new[] { "Code", "Name", "No", "Prefix" });

            migrationBuilder.CreateIndex(
                name: "IX_L01_TimeDefectLib_ZoneTypeId",
